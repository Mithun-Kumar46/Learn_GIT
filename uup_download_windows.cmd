@echo off
:: Generated on 2025-06-24 02:21:33 GMT
...
:START_PROCESS
title 22631.5548_amd64_en-us_core_c2151bd2 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=c2151bd2-59f9-4a1a-8d49-49c53a9498fa&pack=neutral&edition=app&aria2=2"
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=c2151bd2-59f9-4a1a-8d49-49c53a9498fa&pack=en-us&edition=core&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
